...
<head>
     ...
     <meta name="description" content="Venta de tiquetes en Linea">
     ...
     <link rel="stylesheet" type="text/css" href="<?php echo media(); ?>DataTables/css/datatables.bootstrap5.min.css">
...
<body class="app sidebar-mini">
     ...
     <header class="app-header">
          <a class="app-header__logo" href="<?php echo base_url() ?>">Smarticket</a>
