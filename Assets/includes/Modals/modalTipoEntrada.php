<!-- Modal -->
<div class="modal fade" id="modalTipoEntradas" aria-labelledby="titleModal" role="dialog" tabindex="-1" aria-hidden="true">
     <div class="modal-dialog">
          <div class="modal-content">
               <div class="modal-header headerRegister">
                    <h5 class="tile-title" id="titleModal">Agregar Tipo Entrada</h5>
               ...
               <div class="modal-body">
                    <div class="tile">
                         <div class="tile-body">
                              <form id="frmTipoEntrada" name="frmTipoEntrada">
                                   <input type="hidden" name="idTipoEntrada" id="idTipoEntrada" value="0">
                                   <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                             <div class="form-group" id="lstTipoEntrada">
